...
class CarnegieBulkLeafChemistry < ActiveRecord::Base
  ...
  validates :n, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
  # chl_a - mg g^(-1) dry mass
  # chl_b - mg g^(-1) dry mass
  # carotenoids - mg g^(-1) dry mass
  validates :soluble_c, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
  ...
  validates :p, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
  validates :ca, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
  validates :k, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
