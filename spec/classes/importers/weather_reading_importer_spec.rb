...
describe WeatherReadingImporter do
  ...
  before :each do
    @plot = set_up_plot 'SPD01'
  end

  it 'can read csv' do
    values = CSV.parse_line '1,SPD01,1,A,S,"NUBLADO CON NIEBLA, LUZ DIFUSA",Allie added climate codes based on description,6/18/2013 11:15'
