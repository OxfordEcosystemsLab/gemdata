...
describe EgmSoilRespirationImporter do
  ...
  it 'can read CSV' do
    ...
    values = CSV.parse_line 'IVI-02,25,NA,NA,TOT,NA,NA,NA,1,2015,NA,20,25,7,10,57,492,51,91,0.51,957,8,NA,comment'
  ...
  it 'can cope with NA in date' do
    values = CSV.parse_line 'IVI-02,25,NA,1,TOT,NA,NA,NA,1,2015,1,20,25,7,NA,NA,492,51,91,0.51,957,8,NA,comment'
